...
Элементы неупорядоченного списка начинаются с одного из символов -, + или * за которым следует пробел.
Маркеры одного списка должны быть однотипными.

Если маркер списка меняется (например, с - на +), начинается новый список:
- first		
+ second
...
Перед вложенным тегом обязательно должно стоять 4 дополнительных пробела с каждым уровнем вложенности.
- first			
	- second
		- third
...
Внутри элементов неупорядоченного списока могут присутствовать все прочие символы разметки с указанными правилами.
